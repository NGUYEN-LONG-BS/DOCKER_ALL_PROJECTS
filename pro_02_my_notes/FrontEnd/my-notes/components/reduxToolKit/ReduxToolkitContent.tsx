// components/ReduxToolkitContent.tsx
import Image from "next/image";
import { Prism as SyntaxHighlighter } from "react-syntax-highlighter";
import vscDarkPlus from "react-syntax-highlighter/dist/esm/styles/prism/vsc-dark-plus";

export default function ReduxToolkitContent() {
  return (
    <div className="container my-5">
      <h1 className="text-center mb-5">Redux Toolkit</h1>
      ...
      {/* configureStore */}
      <div id="configureStore" className="card mb-4 shadow-sm">
        <div className="card-body">
          <h2 className="section-title card-title">1. Store - configureStore</h2>
          <p>
...
export default store;
          ...
          <div>
            ...
            <Image
              src="/nextjs/ReduxDataFlowDiagram.gif"
          ...
          <div>
            <p>Khi có store, ứng dụng không cần truyền dữ liệu từ cha vào con, mọi component đều lấy data từ store ra:</p>
            <Image
              src="/nextjs/redux-store.webp"
              alt="Redux Data Flow with store"
              width={500}
              height={300}
              style={{ display: "block", margin: "0 auto" }}
            />
            <p>Trong Redux Toolkit, Store sẽ chứa các slice. Slices là các kết hợp giữa state, actions và reducers. Vậy trước khi sử dụng slice, chúng ta cần tìm hiểu lần lượt: State, Actions, Reducers.</p>
          </div>
        </div>
      </div>

      {/* State */}
      <div id="State" className="card mb-4 shadow-sm">
        <div className="card-body">
          <h2 className="section-title card-title">2. State</h2>
          <p>
            <strong>State</strong> là dữ liệu của ứng dụng tại một thời điểm cụ thể. Có thể hiểu nó là tập hợp các giá trị của một component tại một thời điểm.
          </p>
          <ul>
...
const initialState: DocumentNumberState = {
  documentNumber: \`TB-PNK-\${currentYear}0001\`,
      ...
      {/* createAction */}
      <div id="createAction" className="card mb-4 shadow-sm">
        <div className="card-body">
          <h2 className="section-title card-title">3. Action</h2>
          <p>
...
dispatch(setTheme('dark'));
      ...
      {/* createReducer */}
      <div id="createReducer" className="card mb-4 shadow-sm">
        <div className="card-body">
          <h2 className="section-title card-title">4. Reducer</h2>
          <p>
...
export default counterReducer;
      ...
      {/* createSlice */}
      <div id="createSlice" className="card mb-4 shadow-sm">
        <div className="card-body">
          <h2 className="section-title card-title">5. Slice - createSlice</h2>
          <p>
            Như đã đề cập ở trên, <strong>Slice</strong> là kết hợp giữa state, actions và reducers.
          </p>
          <p>
            <strong>createSlice</strong> là công cụ mạnh mẽ để tạo reducer và action creators đồng thời. Nó giảm thiểu boilerplate code bằng cách tự động sinh ra action types và action creators dựa trên các reducer được định nghĩa.
          </p>
          <strong>Các tính năng chính:</strong>
          <ul>
...
export default counterSlice.reducer;
      ...
      {/* createAsyncThunk */}
      <div id="createAsyncThunk" className="card mb-4 shadow-sm">
        <div className="card-body">
          <h2 className="section-title card-title">6. createAsyncThunk</h2>
          <p>
...
export default userSlice.reducer;
      ...
      {/* createSelector */}
      <div id="createSelector" className="card mb-4 shadow-sm">
        <div className="card-body">
          <h2 className="section-title card-title">7. createSelector</h2>
          <p>
...
export default selectFilteredTodos;
      ...
      {/* middleware */}
      <div id="middleware" className="card mb-4 shadow-sm">
        <div className="card-body">
          <h2 className="section-title card-title">8. Middleware</h2>
          <p>
...
export default store;
          ...
          <div>
            ...
            <Image
              src="/nextjs/ReduxAsyncDataFlowDiagram.gif"
              alt="Redux Data Flow Diagram"
              width={500}
              height={300}
              style={{ display: "block", margin: "0 auto" }}
      ...
      {/* RTK Query */}
      <div id="rtkQuery" className="card mb-4 shadow-sm">
        <div className="card-body">
          <h2 className="section-title card-title">9. RTK Query</h2>
          <p>
...
export const { useGetPostsQuery, useAddPostMutation } = postApi;
      ...
      {/* Next.js 15 */}
      <div id="NextJs15" className="card mb-4 shadow-sm">
        <div className="card-body">
          <h2 className="section-title card-title">10. Cấu trúc cây thư mục trong dự án Next.js 15 (App Router và TypeScript)</h2>
          <p>
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    ...
    <html lang="en">
      ...
      <div className="card mb-4 shadow-sm">
        <div className="card-body">
          <h2 className="section-title card-title">Lợi ích của Redux Toolkit</h2>
