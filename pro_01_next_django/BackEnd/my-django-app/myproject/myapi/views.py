...
from .models_TB import TB_CLIENT_CATEGORIES, TB_INVENTORY_CATEGORIES, TB_SUPPLIER_CATEGORIES
...
# CLIENT CATEGORIES
from .models_LA import LA_CLIENT_CATEGORIES, LA_INVENTORY_CATEGORIES, LA_SUPPLIER_CATEGORIES
