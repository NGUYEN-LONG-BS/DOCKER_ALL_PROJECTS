...
def import_bulk_data_NAMAN_INVENTORY_CATEGORIES(request):
    ...
    try:
        ...
        for idx, row in enumerate(rows[1:], start=2):
            ...
            if ma_hang and NAMAN_INVENTORY_CATEGORIES.objects.using(DATABASE_NAME).filter(ma_hang=ma_hang, xoa_sua="new").exists():
        ...
        for idx, row in enumerate(rows[1:], start=2):
            ...
            NAMAN_INVENTORY_CATEGORIES.objects.using(DATABASE_NAME).create(
