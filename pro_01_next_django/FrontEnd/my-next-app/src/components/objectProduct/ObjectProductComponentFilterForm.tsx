...
import {
  ...
  setUnitPrice,
  setNotes,
} from "../../features/formReceiptLog/objectProductFilterFormSlice";
...
interface ProductComponentFilterFormProps {
  onProductChange?: (ProductProps: InventoryItemExport) => void;
}

export function ProductComponentFilterForm({ onProductChange }: ProductComponentFilterFormProps) {
