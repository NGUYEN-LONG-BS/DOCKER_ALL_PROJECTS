...
interface ClientComponentProps {
  onSupplierChange?: (supplier: ClientData) => void
}

export function ClientComponent({ onSupplierChange }: ClientComponentProps) {
  const [supplier, setSupplier] = useState<ClientData>({
    code: "",
    name: "",
    taxId: "",
    address: "",
