...
import { InventoryTableStockReceiveSlip } from "./Tab05Table";
...
export function InventoryLogStockIssueSlip() {
  ...
  // Thêm hàm này trong component InventoryLogStockIssueSlip
