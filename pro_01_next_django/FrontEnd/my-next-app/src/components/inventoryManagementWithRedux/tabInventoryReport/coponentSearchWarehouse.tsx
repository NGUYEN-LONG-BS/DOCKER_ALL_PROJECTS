...
const InventoryNoteOfStockReceiveSlip = ({
  ...
  // Nếu chưa chọn kho, mặc định lấy tên kho đầu tiên
  const selectedWarehouseName =
    warehouses.find((w) => w.ma_kho === selectedWarehouse)?.ten_kho ||
    (warehouses.length > 0 ? warehouses[0].ten_kho : "Chọn kho để hiển thị tên");
  ...
  return (
    <div 
      ...
      <div className="row g-1">
        ...
        {/* Input cho ghi chú */}
        <div className="col-md-9 d-flex align-items-center" style={{ minHeight: 38, paddingLeft: 12 }}>
          {/* Hiển thị tên kho đã chọn */}
